...
import (
	...
	"banners_oto/internal/utils/sanitizer"
	"errors"
	"io"
	"mime/multipart"
	"net/http"
...
func NewDeliveryLayer(ucSessionProps session.Usecase, ucUserProps ususer.Usecase, loggerProps *zap.Logger, metrics *metrics.Metrics) *Delivery {
	return &Delivery{
		ucUser:    ucUserProps,
